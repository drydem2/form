...
function setListeners(userCard) {
    ...
    changeBtn.addEventListener('click', () => {
        ...
        const newPhoneNumberInput = document.querySelector('#phoneNumber')
        const newCityInput = document.querySelector('#city')
        const userData = storage[userEmail]

        newNameInput.value = userData.name
        newSecondNameInput.value = userData.secondName
        newEmailInput.value = userEmail
        newPhoneNumberInput.value = userData.phoneNumber
...
function checkCustomCity(value) {
...
function addCard(e) {
    ...
    if (!newEmail.value
        ...
        resetInputs(newName, newSecondName, newEmail, newPhoneNumber, newCity)
        return
    }
    ...
    if (storage[newEmail.value]) {
        const userCard = document.querySelector(`[data-user="${newEmail.value}"]`)
    ...
    localStorage.setItem('users', JSON.stringify(storage))
    resetInputs(newName, newSecondName, newEmail, newCity, newPhoneNumber)
